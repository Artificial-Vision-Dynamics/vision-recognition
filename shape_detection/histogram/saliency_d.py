...
img = cv2.imread('shape_detection/histogram/esqui.jpg')
...
if tipo == 1:
    ...
    img_thr = cv2.bitwise_and(img, img, mask=threshMap)
    cv2.imshow('Threshold OTSU', img_thr)
    cv2.imwrite('orb/esqui.jpg', img_thr)
